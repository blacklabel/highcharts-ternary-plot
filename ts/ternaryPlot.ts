...
//export default function TernaryPlotPlugin(Highcharts: typeof Highcharts): void {
export default function TernaryPlotPlugin(H: any): void {
    ...
    ***/
    wrap(H.Chart.prototype, 'init', function (this: any, p: any, userOptions: any, callback: any) {
    ...
    ***/
    ...
    H.wrap(H.Chart.prototype, 'setChartSize', function (this: any, p: any) {
        const chart = this,
            options = chart.options;
        ...
        chart.ternaryAxis.forEach(function (this: any, axis: any, i: any) {
    ...
    ***/
    H.Chart.prototype.toPerspective = function (this: any, point: any): any {
        const chart = this,
